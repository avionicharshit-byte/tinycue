...
The wheel carries copies at `tinycue/runtime/`. A checkout has the originals in
...
def runtime_dir() -> Path:
    """The folder holding tinycue.h and tinycue.c."""
...
def copy_runtime(out_dir) -> list[Path]:
    """Copy tinycue.h and tinycue.c into a folder. Returns what was written."""
    source = runtime_dir()
    out = Path(out_dir)
